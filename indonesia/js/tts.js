...
function submitString(concat, tipe, tabel) {
    if (concat.toUpperCase() == "NONI" && tipe == "m3") {
        pengulanganTabel(tabel);
    } else if (concat.toUpperCase() == "MUSEUM" && tipe == "m1") {
        pengulanganTabel(tabel);
    } else if (concat.toUpperCase() == "KOMPENI" && tipe == "d2") {
        pengulanganTabel(tabel);
    } else if (concat.toUpperCase() == "PERANG" && tipe == "m4") {
        pengulanganTabel(tabel);
    }
}
